...
In this host the dsh-crew MCP tools are namespaced: wherever the playbook says `dsh_run_worker`, call `dsh-crew__dsh_run_worker`, and likewise for the other five tools.
