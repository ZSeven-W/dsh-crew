...
var tierSchema = external_exports.enum(["flash", "pro"]).optional().describe("Worker model tier: flash = deepseek-v4-flash (simple tasks), pro = deepseek-v4-pro (harder tasks). Omit to use the session default. Ignored when worker= is set.");
