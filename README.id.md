...
<p align="center">
  <sub>npm: <code>@zseven-w/dsh-crew</code> &middot; Rilis plugin saat ini: <code>0.1.0-rc.11</code> &middot; Diuji dengan DSH <code>0.1.1-rc.1</code></sub>
</p>
...
- **Deteksi otomatis**: shim MCP para host mendeteksi hub secara otomatis (env var `DSHPLUGIN_CREW_HUB`, default `http://127.0.0.1:3080`)
