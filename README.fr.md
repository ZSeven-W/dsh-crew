...
<p align="center">
  <sub>npm: <code>@zseven-w/dsh-crew</code> &middot; Version actuelle du plugin : <code>0.1.0-rc.10</code> &middot; Testé avec DSH <code>0.1.1-rc.1</code></sub>
</p>
...
- **Détection automatique** : le shim MCP des hôtes détecte automatiquement le hub (variable d'environnement `DSHPLUGIN_CREW_HUB`, défaut `http://127.0.0.1:3080`)
