...
<p align="center">
  <sub>npm: <code>@zseven-w/dsh-crew</code> &middot; Текущий релиз плагина: <code>0.1.0-rc.10</code> &middot; Проверено с DSH <code>0.1.1-rc.1</code></sub>
</p>
...
- **Автоопределение**: MCP-прослойка хостов автоматически определяет hub (переменная окружения `DSHPLUGIN_CREW_HUB`, по умолчанию `http://127.0.0.1:3080`)
